...
import io
with io.open(r'icp7.txt', "w+", encoding="utf-8") as f:
...
from nltk.tokenize import word_tokenize, wordpunct_tokenize#this one is for tokenization

from nltk.stem import LancasterStemmer#this one is for stemming
...
j = []
# #
with io.open(r'icp7.txt', "r", encoding="utf-8") as fo:
